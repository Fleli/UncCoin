...
and uses `UNCCOIN_GPU_CHUNK_MULTIPLIER=128` unless overridden. Before connecting to peers
or completing shutdown, cloud-native mode still runs full verification for burst blocks
that skipped the duplicate Python hash check.
