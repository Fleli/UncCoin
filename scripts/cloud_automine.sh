...
export UNCCOIN_CLOUD_NATIVE_SUMMARY_BLOCKS="${UNCCOIN_CLOUD_NATIVE_SUMMARY_BLOCKS:-100}"
export UNCCOIN_CLOUD_NATIVE_BATCH_BLOCKS="${UNCCOIN_CLOUD_NATIVE_BATCH_BLOCKS:-50}"
export UNCCOIN_CLOUD_NATIVE_TRUST_WORKER_HASH="${UNCCOIN_CLOUD_NATIVE_TRUST_WORKER_HASH:-1}"
export UNCCOIN_CLOUD_NATIVE_START_NONCE="${UNCCOIN_CLOUD_NATIVE_START_NONCE:-100000000}"
